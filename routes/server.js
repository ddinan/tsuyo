...
router.get('/config', async (req, res) => {
    ...
    if (client.guilds.cache.get(req.query.id).members.cache.get(req.session.user.id).permissions.has('ADMINISTRATOR')) return res.redirect('/server/config?id=' + req.query.id)
